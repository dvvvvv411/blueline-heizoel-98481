    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative bg-white/95 border border-red-200/30 rounded-3xl p-10 shadow-xl hover:bg-gradient-to-br hover:from-red-50/30 hover:to-white/95 transition-all duration-300">
      ...
      <PageSection background="gray" className="py-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-8">
            <div className="group">
            <div className="bg-white/95 border border-red-200/30 rounded-2xl p-8 shadow-sm hover:shadow-lg hover:bg-gradient-to-br hover:from-red-50/30 hover:to-white/95 transition-all duration-300 h-full">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="relative group">
              ...
              <div className="relative bg-white/95 border border-red-200/50 rounded-3xl p-10 shadow-lg hover:shadow-xl hover:bg-gradient-to-br hover:from-red-50/40 hover:to-white/95 transition-all duration-300">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/95 border border-green-200/50 rounded-3xl p-10 shadow-lg hover:shadow-xl hover:bg-gradient-to-br hover:from-green-50/30 hover:to-white/95 transition-all duration-300">
                <div className="flex items-center mb-8">
      ...
      <PageSection background="primary" className="py-24">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative bg-white/95 border border-red-200/40 rounded-3xl p-10 shadow-xl backdrop-blur-sm hover:bg-gradient-to-br hover:from-red-50/30 hover:to-white/95 transition-all duration-300">
                <div className="text-center mb-8">
