        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto pt-8">
              <div className="group">
            <div className="relative bg-white/95 backdrop-blur-sm border border-red-200/40 rounded-2xl p-6 shadow-lg hover:shadow-xl hover:bg-gradient-to-br hover:from-red-50/30 hover:to-white/95 transition-all duration-300">
